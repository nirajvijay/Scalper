...
export default function Sellcard({ lastTradedPrice }) {
  ...
  const generateSymbol = (selectedstrikeprice) => {
    ...
    return `NSE:NIFTY${year}${month}${day}${selectedstrikepricece}PE`;
  };
  ...
  useEffect(() => {
    if (
      ...
      toast.success("entered ce stoploss");
  ...
  return (
    <div className="containercardsell">
      ...
      <h1 className="niftypebuyprice">FinNiftyBUY:{niftybuyprice}</h1>
